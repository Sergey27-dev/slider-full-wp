...
class Custom_Slider {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $custom_slider    The string used to uniquely identify this plugin.
	 */
	protected $custom_slider;
	...
	public function __construct() {
		...
		$this->custom_slider = 'custom-slider';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Custom_Slider_Admin( $this->get_custom_slider(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Custom_Slider_Public( $this->get_custom_slider(), $this->get_version() );
	 ...
	 */
	public function get_custom_slider() {
		return $this->custom_slider;
	}
